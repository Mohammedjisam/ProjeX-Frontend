        ...
        <div className="container mx-auto px-4 py-6 relative z-10">
          <div className="flex justify-between items-center">
            ...
            <div className="flex items-center space-x-3">
              <img
                src="https://randomuser.me/api/portraits/men/1.jpg" // Default avatar image
                alt="User avatar"
                className="w-10 h-10 rounded-full border-2 border-primary"
              />
              <span className="text-foreground font-medium">Jisam</span>
            </div>
          </div>
        </div>
        ...
        <div className="container mx-auto px-4 py-20 md:py-32 flex flex-col md:flex-row items-center relative z-10">
          <div className="md:w-1/2 mb-12 md:mb-0">
            ...
            <p className="text-lg mb-10 max-w-md text-foreground/80">
              Empower your team with our intuitive remote collaboration
              platform. Work together, communicate effectively, and achieve
              more.
            </p>
            <button
              className="bg-primary text-primary-foreground px-8 py-4 rounded-md hover:bg-primary/90 transition-all font-medium flex items-center group"
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-5xl mx-auto">
            <div className="stat-card hover:scale-105 hover:shadow-xl">
              ...
              <p className="text-foreground/70">
                Track team progress and motivate them everyday.
              </p>
            </div>
            <div className="stat-card hover:scale-105 hover:shadow-xl">
              <div className="mb-6 p-4 rounded-full bg-primary/10 w-16 h-16 flex items-center justify-center">
              ...
              <p className="text-foreground/70">
                Ensure your users' safety with top-tier encryption.
              </p>
            </div>
            <div className="stat-card hover:scale-105 hover:shadow-xl">
              <div className="mb-6 p-4 rounded-full bg-primary/10 w-16 h-16 flex items-center justify-center">
        ...
        <div className="container mx-auto px-4 relative z-10">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-10 max-w-5xl mx-auto">
            <div className="glass-morphism p-8 rounded-xl hover:scale-105 transition-all duration-300">
              ...
              <p className="text-foreground/70">
                Enhance your productivity by collaborating with your team.
              </p>
            </div>
            <div className="glass-morphism p-8 rounded-xl hover:scale-105 transition-all duration-300">
              <div className="mb-8 overflow-hidden rounded-lg">
              ...
              <p className="text-foreground/70">
                Define and track team goals, breaking down objectives into
                achievable tasks to keep your team targets in sight.
              </p>
            </div>
          </div>
        </div>
            ...
            {pricingTiers.map((tier, index) => (
              ...
              >
                ...
                <div className="p-8">
                  ...
                  <button
                    onClick={() =>
                      navigate("/companyadmin/tenant-form", {
                        state: { plan: tier.id },
                      })
                    }
                      ...
                      <li key={i} className="flex items-start">
                        <Check
                          className={`h-5 w-5 mr-3 ${
                            tier.popular ? "text-primary" : "text-foreground/60"
                          }`}
                        />
                        <span>{feature}</span>
                      </li>
        ...
        <div className="container mx-auto px-4 relative z-10">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 max-w-5xl mx-auto">
            {testimonials.slice(0, 9).map((testimonial, index) => (
              <div
                key={index}
                className="glass-morphism p-6 rounded-xl hover:scale-105 transition-all duration-300"
              >
        ...
        <div className="container mx-auto px-4 text-center relative z-10">
          <div className="glass-morphism max-w-4xl mx-auto py-16 px-8 rounded-2xl">
            <h2 className="text-3xl md:text-5xl font-bold mb-6 bg-gradient-to-r from-primary to-white bg-clip-text text-transparent">
              Buy your Company Virtaul Space
            </h2>
            <p className="text-foreground/80 mb-10 max-w-2xl mx-auto text-lg">
              Celebrate the joy of accomplishment with an app designed to track
              team progress and motivate their efforts.
            </p>
            <button
              className="bg-primary text-primary-foreground px-10 py-4 rounded-md hover:bg-primary/90 transition-all font-medium inline-flex items-center group text-lg"
              onClick={navigateDashboard}
            >
              Get started
              <ArrowRight className="ml-2 group-hover:translate-x-1 transition-transform" />
      ...
      <footer className="py-16 border-t border-border">
        <div className="container mx-auto px-4">
          ...
          <div className="border-t border-border mt-12 pt-8 text-sm text-foreground/60">
            <p>© 2025 ProjeX. All rights reserved.</p>
          </div>
        </div>
      </footer>
    </div>
