// src/pages/manager/ManagerSignup.tsx
"use client";
...
import { 
  useInitiateManagerSignup,
  useVerifyManagerSignup,
  useResendManagerOTP,
  useManagerGoogleSignup
} from "../../hooks/useLogin";
import SignUpForm from "../../components/auth/ManagerSignUpForm";
...
const ManagerSignup = () => {
  ...
  const { mutate: initiateSignup, error: signupError, isPending: isSigningUp } = useInitiateManagerSignup();
  const { mutate: verifySignup, error: verifyError } = useVerifyManagerSignup();
  const { mutate: resendOTP } = useResendManagerOTP();
  const { mutate: googleSignup, isPending: isGoogleSigningUp } = useManagerGoogleSignup();
